...
Future work includes: (1) evaluating \tool on a first-party corpus of
crates.io projects to measure generalizability and corpus-scale warning
prevalence; (2) learning project-specific documentation templates for
\texttt{missing\_errors\_doc} and \texttt{missing\_panics\_doc};
(3) stabilizing \texttt{From}/\texttt{TryFrom} in const contexts to
eliminate the 4 remaining \texttt{\#[allow]} annotations.
